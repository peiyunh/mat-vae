function [net,stats] = rmsprop_train(net, imdb, getBatch, varargin)
...
if strcmp(mode,'train') && isempty(net.cache)
  net.cache = num2cell(zeros(1, numel(net.params))) ;
end
...
if numGpus >= 1
  ...
  if strcmp(mode,'train')
    net.cache = cellfun(@gpuArray,net.cache,'UniformOutput',false) ;
  end
end
if numGpus > 1
...
for p=1:numel(net.params)
  ...
  switch net.params(p).trainMethod
    ...
    case 'gradient'
      net.cache{p} = 0.9 * net.cache{p} + 0.1 * net.params(p).der.^2;
      ...
      net.params(p).value = net.params(p).value ...
          ...
          - thisLR * net.params(p).der./(sqrt(net.cache{p})+1e-4);
